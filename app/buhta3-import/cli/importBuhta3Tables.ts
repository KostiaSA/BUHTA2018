...
export async function importBuhta3Tables() {
    ...
    let tables = await _buhta3Sequelize.query("SELECT * FROM SchemaTable WHERE TableName like 'ТМЦ%' OR TableName like '===Сот%'", {type: _buhta3Sequelize.QueryTypes.SELECT});
