...
export class _SqlSelectTableRowEmitter extends _SqlEmitter {

    constructor(public dialect: SqlDialect, public table: _ISqlTable, public rowId: any, public columns?: string[], public skipColumns?: string[]) {
        super(dialect);
    }
    ...
    toSql(): string {
        ...
        sql.push(" WHERE " + this.identifierToSql(primaryKeyColumn.name) + "=" + this.valueToSql(primaryKeyColumn, this.rowId));
